...
//     console.log(todo);
// }
// Heigh Order Array methods  : ForEach , Map , Filter 
...
// const addNums = (num1 = 1, num2 = 10) => console.log(num1 + num2 );
// addNums(5, 40);
// const addNum = (num1 = 7, num2 = 8) => num1 + num2;
// console.log(addNum(5, 50));
