...
// } );
// ---------------------- FORM ---------------------//
const myForm = documrnt.querySelector('#my-form');
const nameInput = documrnt.querySelector('#name');
const emailInput = documrnt.querySelector('#email');
const msg = documrnt.querySelector('.msg');
const userList = documrnt.querySelector('#users');
