...
// // filter : we want to return todos that completed 
// const todoCompleted = todos.filter(function (todo) {
//     return todo.isCompleted === true ;
// });

// // to get the text of the completed todos : 
...
// Call backs documentation w3school 

// CONDITIONALS

// Simple If/Else Statement
const x = 10;// x= 20 ; to show not true   // remarque de types x = '10' w tcompari ===
const y = 4; 
if (x === 10) {
    console.log('x is 10 ');
}
...
// Ternary operator / Shorthand if statment 
const x = 10; 
